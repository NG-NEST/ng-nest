...
exports.mainRoutes = [
    {
        path: environment_1.environment.layout,
        loadChildren: "src/main/layout/layout.module#LayoutModule"
    },
    { path: "", redirectTo: environment_1.environment.layout, pathMatch: "full" },
    ...exports.shareRoutes
];
exports.layoutRoutes = [
    { path: "", redirectTo: environment_1.environment.defaultPage, pathMatch: "full" },
