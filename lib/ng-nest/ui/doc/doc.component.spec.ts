                ...
                <x-tab label="基础用法">
                  ...
                  <div class="x-examples-code">
                    <x-tabs layout="top" nodeJustify="center" size="medium">
                      <x-tab label="default.component.html"><x-highlight [type]="'html'" [data]="ndfqhd"></x-highlight> </x-tab>
                      <x-tab label="default.component.scss"><x-highlight [type]="'scss'" [data]="dwxdlq"></x-highlight> </x-tab>
                      <x-tab label="default.component.ts"><x-highlight [type]="'typescript'" [data]="cfixqt"></x-highlight> </x-tab>
                    </x-tabs>
                  </div>
                </x-tab>
                <x-tab label="最大值">
                  ...
                  <div class="x-examples-info">
                    <p>
                      由 <code>max</code> 属性定义，它接受一个 <code>number</code>，需要注意的是，只有当 <code>value</code> 为
                  ...
                  <div class="x-examples-code">
                    <x-tabs layout="top" nodeJustify="center" size="medium">
                      <x-tab label="max.component.html"><x-highlight [type]="'html'" [data]="trxoqr"></x-highlight> </x-tab>
                      <x-tab label="max.component.scss"><x-highlight [type]="'scss'" [data]="ghvlqn"></x-highlight> </x-tab>
                      <x-tab label="max.component.ts"><x-highlight [type]="'typescript'" [data]="ezuvkp"></x-highlight> </x-tab>
                    </x-tabs>
                  </div>
                </x-tab>
                <x-tab label="自定义">
                  ...
                  <div class="x-examples-code">
                    <x-tabs layout="top" nodeJustify="center" size="medium">
                      <x-tab label="custom.component.html"><x-highlight [type]="'html'" [data]="olieox"></x-highlight> </x-tab>
                      <x-tab label="custom.component.scss"><x-highlight [type]="'scss'" [data]="ckmbii"></x-highlight> </x-tab>
                      <x-tab label="custom.component.ts"><x-highlight [type]="'typescript'" [data]="wksoii"></x-highlight> </x-tab>
                    </x-tabs>
                  </div>
                </x-tab>
                <x-tab label="小红点">
                  ...
                  <div class="x-examples-code">
                    <x-tabs layout="top" nodeJustify="center" size="medium">
                      <x-tab label="dot.component.html"><x-highlight [type]="'html'" [data]="qpjmie"></x-highlight> </x-tab>
                      <x-tab label="dot.component.scss"><x-highlight [type]="'scss'" [data]="rovvyy"></x-highlight> </x-tab>
                      <x-tab label="dot.component.ts"><x-highlight [type]="'typescript'" [data]="uyewmf"></x-highlight> </x-tab>
                    </x-tabs>
                  </div>
                </x-tab>
                <x-tab label="颜色">
                  ...
                  <div class="x-examples-code">
                    <x-tabs layout="top" nodeJustify="center" size="medium">
                      <x-tab label="color.component.html"><x-highlight [type]="'html'" [data]="pdmpno"></x-highlight> </x-tab>
                      <x-tab label="color.component.scss"><x-highlight [type]="'scss'" [data]="pgjhrb"></x-highlight> </x-tab>
                      <x-tab label="color.component.ts"><x-highlight [type]="'typescript'" [data]="ohpyfz"></x-highlight> </x-tab>
                    </x-tabs>
                  </div>
                </x-tab>
              </x-tabs>
