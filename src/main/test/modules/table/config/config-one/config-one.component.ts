...
@Component({
  selector: 'ex-config-one',
  templateUrl: './config-one.component.html',
  providers: [ConfigService]
})
export class ExConfigOneComponent {
  ...
  columns: XTableColumn[] = [
    { id: 'index', label: '序号1', flex: 0.5, left: 0, type: 'index' },
    { id: 'name', label: '单位1', flex: 1.5, sort: true },
    { id: 'position', label: '公司项目内部模拟利润1', flex: 1, sort: true },
    { id: 'email', label: '政府补助1', flex: 1 },
    { id: 'phone', label: '营业额外收入1', flex: 1 },
    { id: 'organization', label: '项目成本1', flex: 1, sort: true },
    { id: 'rengong', label: '人工成本1', flex: 1, sort: true },
    { id: 'actions', label: '操作1', flex: 1, right: 0 }
  ];
